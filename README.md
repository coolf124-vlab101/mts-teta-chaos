...
## 2. Долгосрочная изоляция: 
Оставить узел изолированным от кластера на длительное время, затем восстановить соединение и наблюдать за процессом синхронизации и
восстановления реплики.
...
При отключении сервера система мониторинга в течении 2 минут недоступности системы высылает сообщение через телеграмм
![ сообщение в телеграмм ](https://github.com/coolf124-vlab101/mts-teta-chaos/blob/main/chaos3_2.png?raw=true)
